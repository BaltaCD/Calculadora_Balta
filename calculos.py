...
print("","","","╚═╝")
print("")
pase = input(RED+ ">> Digite la Contraseña: ")

while pase != contrasenia:
    print("¿",pase,"?","La Contraseña es Incorrecta")
    pase = input(">> Intentelo Otra Vez: ")

print(WHITE+"(･ิᴗ･ิ) Bienvenido")
print("")
